 ...
 * 
 */
@WebService(name = "SearchTemplatePortType", targetNamespace = "http://ns.electronichealth.net.au/tplt/svc/SearchTemplate/1.1")
@SOAPBinding(parameterStyle = SOAPBinding.ParameterStyle.BARE)
@XmlSeeAlso({
    au.net.electronichealth.ns.pcehr.xsd.common.commoncoreelements._1.ObjectFactory.class,
    au.net.electronichealth.ns.tplt.xsd.interfaces.searchtemplate._1.ObjectFactory.class,
...
public interface SearchTemplatePortType {
    ...
    @Action(input = "http://ns.electronichealth.net.au/tplt/svc/SearchTemplate/1.1/SearchTemplatePortType/searchTemplateRequest", output = "http://ns.electronichealth.net.au/tplt/svc/SearchTemplate/1.1/SearchTemplatePortType/searchTemplateResponse", fault = {
        @FaultAction(className = StandardErrorMsg.class, value = "http://ns.electronichealth.net.au/tplt/svc/SearchTemplate/1.1/SearchTemplatePortType/Fault/standardError")
    })
    public void searchTemplate(
        @WebParam(name = "searchTemplate", targetNamespace = "http://ns.electronichealth.net.au/tplt/xsd/interfaces/SearchTemplate/1.0", partName = "parameters")
        SearchTemplate parameters,
        @WebParam(name = "searchTemplateResponse", targetNamespace = "http://ns.electronichealth.net.au/tplt/xsd/interfaces/SearchTemplate/1.0", mode = WebParam.Mode.OUT, partName = "parameters")
        Holder<SearchTemplateResponse> parameters0,
