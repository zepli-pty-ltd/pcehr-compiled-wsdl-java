...
/**
 * Association is the mapping of the same named interface
 *         in ebRIM. It extends RegistryObject. An Association specifies references to two previously
 *         submitted registry entrys. The sourceObject is id of the sourceObject in association The
 *         targetObject is id of the targetObject in association
 * 
